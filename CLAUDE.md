...
- **丰富的场景类型** — 幻灯片、测验、交互式模拟（代码、图表、游戏、3D、仿真）、项目制学习（PBL）
...
│   ├── i18n/                   #   国际化（zh-CN, en-US, ja-JP, ru-RU, ar-SA）
...
2. **场景生成** (`scene-generator.ts`)
   - 每个大纲条目生成为具体场景
   - 支持 9 种场景类型：幻灯片、测验、代码交互、图表交互、游戏化学习、3D可视化、模拟实验、思维导图、PBL
